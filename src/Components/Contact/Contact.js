            ...
            <div className={classes.Contact} id="contact">
                <div className={classes.ContactContent}>
                    ...
                    <div className={classes.FollowUs}>
                        ...
                        <p className={classes.FollowUsText}>Follow us on Instagram <a href="https://www.instagram.com/the_schwab_bakery/" className={classes.FollowUsLink}>@the_schwab_bakery</a></p>
                    </div>
                </div>
            </div>
        )
